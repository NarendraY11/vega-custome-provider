...
const SEARCH = {"action":"https://www.pornhub.com/","method":"get","input":"q"};
const HINTS = {"categoryUrls":["https://www.pornhub.com/categories"],"detailUrls":[],"apiHints":["https://www.pornhub.com/user/premium_redirect_cookie?ajax=1","https://www.pornhub.com/api/v1/user/create_account_check?token=REDACTED","https://www.pornhub.com/api/v1/user/create_account_check?token=REDACTED"]};
